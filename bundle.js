...
module.exports = {"breakfast":{},"lunch":{"Entrée":["Scrambled  Eggs","Hard Cooked Cage Free Egg","Hash Browned Potato","Sausage Link"],"Exhibition":["Omelet Bar"],"Grill":["Grilled Cheese & Tomato Sandwich","Hot Italian Meatball Sandwich","Shoestring French  Fries","Hot Cereal","Oatmeal","Grits"],"International":["Pancake Bar"],"Pizza":["Chocolate Chip Scones","Cake Doughnuts with Powdered Sugar","Blueberry Muffins","Cinnamon Roll","Assorted Mini Danish"],"Salad":["Salad Bar Station"],"Soup":["Vegan Six Bean Soup"],"Vegetarian/Vegan":["Tri-Color Tortilla Chips","Roasted Red Pepper Hummus","Lemony Chickpea Salad","Corn, Tomato, & Basil Salad","Farro Salad with Garden Vegetables","Sun-Dried Tomato Cucumber Relish","Chipotle Ancho Salsa","Tomato Basil Spinach Fettuccine Plate","Baked  Potato","Vegetarian Chili","Green Lentils","Ginger Mango Roasted Potatoes","Roasted Carrots"],"Simple Servings":["Simple Pollock Livornaise","Quinoa with Squash, Tomatoes and Basil","Italian Green Beans"]},"dinner":{"Entrée":["Roasted Pork Loin","Baked Potato Small","Whole Green Beans","Warm Cinnamon Applesauce"],"Exhibition":["Fusilli","Whole Wheat Penne","Spaghetti Sauce with Tomato Bits","Diablo Sauce"],"International":["Big Ole Beef Burrito","Mild Salsa"],"Pizza":["Pepperoni Pizza","Vegetable Lovers Feast Pizza","Cheese Pizza"],"Salad":["Salad Bar Station"],"Soup":["Vegan Six Bean Soup"],"Vegetarian/Vegan":["Tri-Color Tortilla Chips","Hummus","Lemony Chickpea Salad","Corn, Tomato, & Basil Salad","Farro Salad with Garden Vegetables","Sun-Dried Tomato Cucumber Relish","Chipotle Ancho Salsa","Artichoke & Zucchini Paella","Moroccan Couscous","Vegetarian Chili","Baked Sweet Potato","Green Lentils","Roasted Carrots","Southern Indian Roasted Potatoes"],"Simple Servings":["Simple Pork Green Chile","Rice","Grilled Zucchini"]},"late_night":{"Entrée":["Asian Theme Bar"]}}
